"""
Business Service - Business Logic & Settings
Port: 8003
"""
...
logger = setup_logging("business-service")
config = get_config()
...
@app.get("/")
async def root():
    return {"service": "business-service", "version": "1.0.0", "status": "running"}


if __name__ == "__main__":
    import uvicorn
    uvicorn.run("main:app", host="0.0.0.0", port=8003, reload=config.DEBUG)
