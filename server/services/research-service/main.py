"""
Research Service - Research & Data Enrichment
Port: 8010
"""
...
logger = setup_logging("research-service")
config = get_config()
...
app = FastAPI(title="Research Service", version="1.0.0", lifespan=lifespan)
...
@app.get("/")
async def root():
    return {"service": "research-service", "version": "1.0.0", "status": "running"}


if __name__ == "__main__":
    import uvicorn
    uvicorn.run("main:app", host="0.0.0.0", port=8010, reload=config.DEBUG)
